            ...
            <div className="app-main">
                ...
                <main className="w-full px-4 pb-10 pt-4 sm:px-5 xl:px-6">
                    ...
                    {loading && <div
                        ...
                        <LoaderCircle size={18} className="animate-spin"/> Đang tải dữ liệu...</div>}
                    {loadError && <div
                        ...
                        <button type="button" className="font-semibold underline" onClick={loadData}>Thử lại</button>
                    </div>}
                    {eligibleOfficersLoading && <div
                        className="mb-3 flex items-center gap-2 rounded-lg border border-blue-100 bg-blue-50 px-4 py-3 text-sm font-medium text-blue-700">
                        <LoaderCircle size={18} className="animate-spin"/> Đang tải cán bộ phù hợp theo lĩnh vực...
                    </div>}
                    {eligibleOfficersError && <div
                        className="mb-3 flex items-center gap-2 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
                        <AlertCircle size={18}/>{eligibleOfficersError}</div>}
                    {actionError && <div
                        className="mb-3 flex items-center gap-2 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
                        <AlertCircle size={18}/>{actionError}</div>}
