...
const icons = { total: FileText, processing: Clock3, completed: Check, risk: AlertTriangle, waiting: Hourglass, confirmed: CircleUserRound }
const tones = {
